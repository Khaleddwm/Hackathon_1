...
<nav class="navbar navbar-expand-lg">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="trip.php">TOP DESTINATION</span></a>
      </li>
    </ul>
    <form class="form-inline my-2 my-lg-0" action="search.php" method="get">
      <input class="form-control mr-sm-2"  type="text" name="search" placeholder="NOM DE FILM " required>
      ...
      <button class="btn btn-outline-primary my-2 my-sm-0" type="submit" style="color: lightgray; font-weight: 500; border-color: lightgrey; padding-top: 0;padding-bottom: 0;"> rechercher</button>
    </form>
  </div>
</nav>
</header>
